...
import { deleteDocuments } from '@/redux/features/document/documentSlice';
import { showCompleteAlert, showWarningAlert } from '@/redux/features/common/alertSlice';
import { addDocumentsToTrash, addDocumentToFolderTrash } from '@/redux/features/trash/trashSlice';
import { removeDocumentFromFolder } from '@/redux/features/folder/folderSlice';
