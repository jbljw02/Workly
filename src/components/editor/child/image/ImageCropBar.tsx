...
export default function ImageCropBar({ id, cropApply, cropCancel }: ImageCropBar) {
    ...
    return (
        <div className='flex flex-row items-center w-[84px] absolute bottom-[-90px] left-1/2 -translate-x-1/2 transform px-1 py-2 text-sm rounded-md z-20 bg-white border border-gray-200 shadow-[0px_4px_10px_rgba(0,0,0,0.25)]
