...
export default function ImageCropBar({ cropApply, cropCancel }: ImageCropBar) {
    return (
        <div className='flex flex-row items-center absolute bottom-[-48px] right-[-3px] transform p-1 text-sm rounded-md z-20 bg-white border border-gray-200 shadow-[0px_4px_10px_rgba(0,0,0,0.25)]'>
            <button
